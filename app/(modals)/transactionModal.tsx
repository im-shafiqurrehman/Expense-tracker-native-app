...
import { showAlert, showTransactionAlert } from "@/utils/alerts";
...
const TransactionModal = () => {
    ...
    const onSubmit = async () => {
        ...
        if (!amount || !walletId || !date || (type === "expense" && !category)) {
            showTransactionAlert.validation();
            return;
        }
        ...
        if (res.success) {
            ...
            showAlert.error("Transaction", res.msg);
        }
    };
    const onDelete = async () => {
        ...
        if (res && res.success) {
            ...
            showAlert.error("Transaction", res?.msg || "Failed to delete transaction");
        }
    };
    const showDeleteAlert = () => {
        showTransactionAlert.deleteConfirmation(onDelete);
    };
